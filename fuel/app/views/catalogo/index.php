    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <div class="row">
                    <div class="col-12">
                        <h3 class="text-center title-primary-1 h1 space space-top">Todas las categorías</h3>
                    </div>
                </div>
                <div class="row">
                                ...
                                <div class="row mx-n2 mx-md-n3">
                                    ...
                                    <?php else: ?>
                                        <div class="alert alert-secondary" role="alert">
                                            ...
                                            <hr>
                                            <p class="text-justify">Por el momento no tenemos artículos de esta clasificación, estamos trabajando para ofrecerte los mejores productos y publicarlos a la brevedad. Te sugerimos ver otras categorías o buscar a través del cuadro de búsqueda el artículo que deseas.</p>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                <div class="row">
