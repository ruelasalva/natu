                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="bg-white rounded border text-center p-4">
                            ...
                            <p class="my-4 text-primary h3 text-justify">Tu pedido ha sido enviado con éxito.<br><br>Por favor realiza la transferencia o depósito en nuestra cuenta y envíanos el comprobante junto con el ID de referencia <strong><?php echo $sale_id; ?></strong> a nuestro correo <strong>atencionaclientes@naturaymas.com.mx</strong>, mientras te invitamos a seguir navegando en nuestra tienda en línea.</p>
